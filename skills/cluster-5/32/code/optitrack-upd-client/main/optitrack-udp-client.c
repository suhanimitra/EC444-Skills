/* optitrack-udp-client
   2024-11-09
   Adapted from ESP example code udp-client

   Changes required for optitrack

   Payload is requested ID (string)
   Response is (x,y,theta,status)
...
static const char *payload = "ROBOTID 2";
