...
static void test_alpha_display() {
    ...
    char input[16];
    //echo back what i type
    printf("Enter up to 16 characters: ");
    ...
    while (1) {
        // Scroll through the input string
        for (int offset = 0; offset <= input_len - 4; offset++) {
            ...
            if(ret == ESP_OK) {
                printf("- wrote input string segment: %.*s\n\n", 4, &input[offset]);
            }

            vTaskDelay(1000 / portTICK_PERIOD_MS);  // Delay for scrolling effect (1 second)
        }

        // Optional: Add a wrap-around effect
        vTaskDelay(1000 / portTICK_PERIOD_MS);  // Delay before restarting scroll
    }
